 ...
 * @param private_key - Ed25519 private key (unsigned binary data, low endian, 32 byte)
 * @return 0 on success
 */
int mbedtls_ext_ed25519_getpub(unsigned char* public_key, const unsigned char* private_key);
 ...
 * @param private_key - Ed25519 our private key (unsigned binary data, low endian, 32 byte)
 * @return 0 on success
 */
